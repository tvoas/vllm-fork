...
@ReasoningParserManager.register_module("holo2")
class Holo2ReasoningParser(ReasoningParser):
    """
    Reasoning parser for the Holo2 models which are based on Qwen3.

    The Holo2 model uses <think>...</think> tokens to denote reasoning text
    but <think> is part of the chat template. This parser extracts the
    reasoning content until </think> in the model's output.
    ...
    def __init__(self, tokenizer: AnyTokenizer, *args, **kwargs):
        ...
        # Deepseek V3 and Holo2 are similar. However, Holo2 models think by
        # default. this parser without user specified chat template args is
        # initiated once for all requests in the structured output manager.
        # So it is important that without user specified chat template args,
        # the default thinking is True.
    ...
    def extract_reasoning_content(
            ...
            request: ChatCompletionRequest) -> tuple[str | None, str | None]:
