...
class AsyncLLMEngine(EngineClient):
    ...
    async def run_engine_loop(engine_ref: ReferenceType):
        ...
        while True:
            ...
            elif not all(has_requests_in_progress
                         ) and request_tracker.has_new_requests():
            ...
            try:
                ...
                # After processing completions, if new requests arrived
                # and idle VEs exist, launch them immediately.
