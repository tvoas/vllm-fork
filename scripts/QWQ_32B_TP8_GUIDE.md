...
cd vllm-fork
sudo docker build -f docker/Dockerfile.hpu_plugin \
...
```bash
python3 vllm/benchmarks/benchmark_serving.py --backend vllm --model /root/.cache/huggingface/GLM-4.5-FP8 --trust-remote-code --host 127.0.0.1 --port 8688 --dataset-name random --random-range-ratio 0.1 --random-input-len 2048 --random-output-len 16384 --max-concurrency 1 --num-prompts 20 --request-rate inf --seed 0 --ignore-eos --save-result --percentile-metrics ttft,tpot,itl,e2el --metric-percentiles 90,95,99 --result-filename online_enchmark_results.json; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; python3 vllm/benchmarks/benchmark_serving.py --backend vllm --model /root/.cache/huggingface/GLM-4.5-FP8 --trust-remote-code --host 127.0.0.1 --port 8688 --dataset-name random --random-range-ratio 0.1 --random-input-len 2048 --random-output-len 16384 --max-concurrency 1 --num-prompts 20 --request-rate inf --seed 0 --ignore-eos --save-result --percentile-metrics ttft,tpot,itl,e2el --metric-percentiles 90,95,99 --result-filename online_enchmark_results.json; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi
...
```bash
clear
pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi


export HF_ALLOW_CODE_EVAL=1; export LM_ADDR=127.0.0.1; export LM_PORT=8688; export LM_MODEL=/root/.cache/huggingface/GLM-4.5-FP8; export LM_CONCURRENCY=32; export LM_BATCH_SIZE=1; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; curl -X POST http://127.0.0.1:8688/reset_prefix_cache; hl-smi; sleep 5; hl-smi; pytest -s test_dynamic.py; hl-smi; sleep 5; hl-smi;

watch -n 1 'cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "|humaneval|"; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Benchmark duration (s)"; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep " goodput percentage "; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Mean decoding throughput ";  cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Total E2E output"; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Mean TTFT "; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Mean TPOT"; echo ""; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "/370 " | tail -n 1 | head -c 2000'

curl -X POST http://127.0.0.1:8688/reset_prefix_cache

clear; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "|humaneval|"; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Benchmark duration (s)"; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep " goodput percentage "; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Mean decoding throughput ";  cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Total E2E output"; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Mean TTFT "; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "Mean TPOT"; echo ""; cat /mnt/disk1/models/full_8x_tp8pp1_e8bdb2a0_ylsfsdpa_sangfor_r008.log | grep "/370 " | tail -n 1 | head -c 2000


export LM_BATCH_SIZE=1
export LM_CONCURRENCY=1
python vllm/benchmarks/benchmark_serving.py --backend vllm --model ${LM_MODEL} --trust-remote-code --host ${LM_ADDR} --port ${LM_PORT} --dataset-name random --random-input-len 2048 --random-output-len 8 --random-range-ratio 1.0 --num-prompts 4 --request-rate inf --seed 0 --ignore_eos --max-concurrency ${LM_CONCURRENCY} --percentile-metrics ttft,tpot,itl,e2el  --metric-percentiles 10,99


export LM_LIMIT=128
export LM_CONCURRENCY=32
